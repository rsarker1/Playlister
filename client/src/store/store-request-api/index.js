...
export const createPlaylist = (newListName, newSongs, userEmail, userName, userFirstName, userLastName) => {
...
export const getPPPairs = (string) => api.get(`/publishedpairs/${string}`)
